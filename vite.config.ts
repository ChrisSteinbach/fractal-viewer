    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          ...
          // fr-vja8.32: "any" and "maskable" want DIFFERENT art (full-bleed
          // vs padded) — a single "any maskable" entry let Android's
          // adaptive-icon mask clip icon.svg's triangle tips, which sit
          // outside its ~80%-diameter safe circle. This second entry is a
          // separately padded raster (icon.svg's own artwork rescaled to
          // 60% about its center, full-bleed background, no rounded
          // corners — a mask supplies its own shape), generated by
