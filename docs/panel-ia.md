...
| **Renderer-owned Scene color**                   | Scene / Look / Renderer        | One visible section for the active renderer: Points color mode/4D color, Flame tone and palette, Solid palette, or Surface source/palette/speed                                            | Document                                                                                                                       | Use the same **Scene color** name for the same current-view question, but never show another renderer's editor beside it. Keep the Points flat/non-flat selector pair and dependents in the Points presentation. Flame, Solid, and Surface retain their own values while hidden. Solid Classic and Surface Height/Radius may consume the saved Points color definition internally; that persistence does not make the Points editor visible outside Points.                                                                                                                                                                                                                  |
