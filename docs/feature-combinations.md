...
| Emitter-only Surface scenes                                                       | Finite C0 has no recursive alphabet; root-excluding depth bands are empty                                                                    | Admitted in 3D/4D with root depth 0, qualified B prefixes and xaos. [Qualification](emitter-only-surface.md) covers traversal, attribution and empty-band recovery.                                            |
