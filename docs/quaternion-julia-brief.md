...
> **Status: historical.** This is the brief the quaternion-Julia epic was written from, kept for its background and
...
> | --------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
> | "the DE Surface mode runs in seconds on a phone but minutes on an Ubuntu laptop, suggesting the laptop browser has fallen back to software rasterization" | **Refuted.** Both real browsers get a Vulkan-backed adapter and the app selects WebGPU compute on each. The mechanism is real but was not active here.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
> | **Option A (recommended): quaternion Julia sets**                                                                                                         | **Demoted** (from `scripts/qjulia-beauty.harness.ts`'s sheets). The oracle shipped and is exact, certified and the cheapest estimator in the codebase — but the object is SMOOTH: twenty panels across rotations, rotor-posed slices, non-zero `w0` and several constants are shells and whorls without fractal detail, and three levels of zoom on four systems reveal nothing new. Surface mode's promise is that zoom keeps resolving. Its WGSL/GLSL renderer cores and its 4D lift are CLOSED won't-do — the rotor-posed slice this option's 4D lift rested on was tested among those panels and is smooth too. The oracle stays, and the escape chain's cross-family power links use its exact derivative. |
> | **Option B: Juliabulb** (originally deferred)                                                                                                             | **Shipped** — as the Mandelbulb rather than the Juliabulb, since this family had already settled on the Mandelbrot form. Measured 3.5x CHEAPER per eval than the fold mode that already shipped, refuting the prediction going in.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
> | **Option C: Julia-mode hybrids**                                                                                                                          | **Shipped**: the transform list is a formula chain and fold links compose, and cross-family links — a fold chained with a triplex power or a quaternion square — landed after them.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
> | Task 5, "optional, flame mode: support a `juliaN`-type variation"                                                                                         | **Already existed.** `variations.ts`'s `julia` has been flam3's `juliaN(power=2, dist=1)` all along. See `docs/julia-sets.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
>
