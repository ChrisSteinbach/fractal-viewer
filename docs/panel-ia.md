...
| **Flat / non-flat Scene color and Depth**        | Scene / Look                   | Flat and non-flat Points; Scene color also feeds applicable Flame/Solid paths, while Surface has its own sources                                                                           | Document                                                                                                                       | Keep active non-flat Color/Depth enabled and the stored flat Color selector visible-disabled with an adjacent scope note. The shared section is named **Scene color** so the pair with Surface's contextual **Surface color** reads as families rather than duplicates. Non-flat Height/Radius/Position share ramp, Contrast and Axis controls with their flat twins; Glow/DOF use the dedicated additive 4D material/composer. Aerial colored haze and EDL remain disabled because they conflict with additive/single-depth assumptions. Surface Height/Radius independently keeps the shared ramp and Contrast live.                                                       |
