...
export const SCALAR_CONTROLS: readonly ScalarControlSpec[] = [
  ...
  {
    kind: "checkbox",
    id: "solidFloorEnabledCheckbox",
    read: (s) => s.solid.floorEnabled,
    apply: (s, checked) => setSolidFloorEnabled(s, checked),
    effect: solidParamsEffect,
  },
  {
    kind: "select",
    id: "solidFloorPatternSelect",
    read: (s) => s.solid.floorPattern,
    apply: (s, raw) => setSolidFloorPattern(s, raw as SurfaceFloorPattern),
    effect: solidParamsEffect,
  },
  {
    kind: "range",
    id: "solidFloorTileScaleSlider",
    label: {
